...
@task(name="PPS Aggregate Positions Task")
def pps_get_positions_data():
    ...
    def update_prefect_block_data(avg_entry_price, total_dot_size, total_swap):
        logger.info("PPS - Updating Prefect Block Data")
